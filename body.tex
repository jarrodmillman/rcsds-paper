...
depository.  In order to design and implement their project, they had to read
and understand at least one published FMRI paper, with little assistance from
their instructors.  We gave no example projects for them to review, or
templates for them to follow.  As we have already described in the results,
the submitted projects were all substantial efforts to reproduce and / or
extend the published results, and all included analysis code that they had
written themselves.
...
teaching, and is better developed for neuroimaging and machine learning.
...
data analysis.  Something like this course would follow, introducing tools for
efficient work with data and with Python code.  There should be follow-up
courses using the same tools for more advanced topics such as
machine-learning, spatial pre-processing, and analysis of other modalities.
We suggest that each of these courses should have group project work as a
large component, in which the student can continue to practice techniques for
efficient reproducible analysis and collaboration.
...
genomics research in R.  Many of the imaging labs in Berkeley take this issue
seriously and transmit this to their students.  If that were not the case,
then it would be correspondingly more difficult to persuade the students of
the importance of working in a reproducible way, especially given the relative
comfort and convenience of less disciplined working process.
...
In the same way, a booming tech sector nearby made it easy to persuade
students they would need to learn tools like Git and Github, as these are
widely used in the tech industry.  For example, public activity on Github is
one factor companies use to identify candidates for well-paid positions as
software engineers.
