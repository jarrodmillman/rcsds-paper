...
are intended to get you used to reading and writing Python code.
Your task for \texttt{dna.py} is to implement a series of functions in Python.
Similarly, in \texttt{cipher.py} the task is to implement methods of a Cipher class.
...
The functions and methods are documented, but not implemented.
...
The third part, involved students analyzing the State of the Union
...
To do this, you will be representing a multidimensional array as a (linear) 1-D list
...
In this assignment we will try to detect outlier 3D volumes in a 4D FMRI image.
The purpose of this part of the homework is for you to practice:
(a) implementing functions on image arrays;
(b) exploring FMRI data for outliers; and
(c) running least-squares fits on different models.
Along the way, we hope you will pick up some more advanced skills for making
and saving plots with matplotlib.
