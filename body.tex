...
We take an alternative approach.  Instead of
...
a shared GitHub repository with their solutions.
...
We required students to use GitHub's pull requests (PRs) and review mechanism
for any work contributed to the project.
...
retrofit.
%To invert a common saying: "A week in the lab saves an hour in the library".
