...
keep track of what you have done without carefully organizing and meticulously
recording your work.  Large datasets and complex analysis are typical in research.
...
mathematical and statistical principles using explanation with simple code.
Our intention was that students should be able to build their own analysis
...
CI\footnote{\url{https://travis-ci.org}\label{travis-ci}} that integrate with code
...
exercises was presented, often in the form of a Jupyter
...
and encouraged the students to build their own analyses given the building
...
the student continue to practice techniques for efficient reproducible
research.
...
toward Python for scientific computing.
...
to use productively for significant, collaborative, and reproducible research.
