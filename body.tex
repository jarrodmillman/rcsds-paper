...
We believe that traditional teaching suffers from an essential error of
emphasis, in giving priority to the overview at the expense of the
intellectual and practical foundations of the analysis.  It aims to give the
big picture, leaving the students to fill in the details.  
\footnote{This figure explains the issue: https://twitter.com/designuxui/status/490179377099845632}
The assumption is
...
keep track of what you have done.  This second situation is typical in
research.
...
% JB: would be good to have a footnote with examples here, I guess excel ? may be jupyter nb ? :)
We used the final project to
show the power of expert tools for serious scientific analysis, especially in
collaboration. 
Other teachers or mentors have also realized the benefits of collaborative projects
and have adopted related approach \citep{huppenkothen_hack_2017}
...
principles with general computational tools.  Our intention was that students
...
can obscure the tree structure of the file system, making it harder for user
of this interface to think about the organization of data as a hierarchy of
directories and files.  The command line tools make the file system hierarchy
explicit, and so make it easier to reason about data organization.
%JB could we do science with smart phones ?
...
We required the groups to write their slides in Markdown and commit them to
...
applied the general linear model to the data to show that removing outlier
scans reduced residual variance from the model fit.
...
% I am not sure why this is a measure of test coverage
...
We are sure that most of our readers would agree that teaching students to
work in this way is desirable; but, given all the other classes our students
must take, can we justify the time and energy that this course needs?  We
believe so.  This is true of students as well as
