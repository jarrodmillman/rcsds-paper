...
(a) to teach efficient reproducible practice with standard expert tools; (b)
to teach fundamental mathematical and statistical principles using explanation
with simple code, and c) students should be able to build their own analysis
