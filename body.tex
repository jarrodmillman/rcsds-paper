...
Since the seminal papers of J. Ioannidis \citep{ioannidis_why_2005}, the issue of reproducibility or replicability in life science has been debated in the literature and attracted the attention of the research community, the funders and the journals editors (see for instance amongst many \citep{collins_nih_2014, allison_reproducibility, horton_offline:_2016}). Since researchers seem to produce a large number of irreproducible results, it is important to consider the causes of this irreproducibility and what can be done to curb the issue. One direct answer is to work to provide the future researchers with the tools and good practices that foster scientific reproducibility \citep{janz_bringing_2015}. We describe here an attempt in this direction . 
}
