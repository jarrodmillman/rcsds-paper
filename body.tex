...
Functions allow you to ``hide'' the details of a discrete bit of
code from view.
This can make it easier to see the higher-level structure of your analysis.
They encourage you to think of your program as a collection of substeps.
Functions allow you to reuse code instead of rewriting or copying and editing it.
...
markup formats as well as produce final documents.
...
after the Git lecture, we used Git and GitHub to fetch and submit all
exercises;
