...
% Jarrod - more meat here?  It's all there in the README.pdf pointed to on day
% 1, but was there more, before the mention of "Teams formed by Thursday" on
% day 6.  I guess that's week 3 or 4?
% it is mentioned above, but here it is:
...
project faith in the teams' ability to define a meaningful and interesting
program of work.  We mention this to say that, a large open-ended project has
many advantages, but to make it work, it does take courage from the
...
Many imaging courses have fewer requirements, and can admit students from
fields that have less training in statistics.   We designed our course such
that a passing student should be competent to join or lead a collaborative
statistical analysis of FMRI data.  We do not believe we could have covered
the necessary material without a requirement in statistics.  We can imagine
courses with a different desired outcome; for example, a course might aim to
give the students some familiarity with the language used in FMRI analysis, to
help them collaborate with other researchers that lead the analysis.  In that
case, it may be acceptable that students do not have a basic understanding of
the statistical methods, and the course might not have a requirement in
statistics.
