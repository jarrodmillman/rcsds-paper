...
Traditional teaching on neuroimaging emphasizes
the big picture and attempts to introduce students to many conceptual elements
    of image analysis.
Our approach emphasizes
(a) the computational tools to ensure
computationally reproducible daily work as well as
(b) a clear understanding of the statistical techniques used
for a basic analysis of a single run in an MRI scanner.
The course was broadly successful in engaging students in a real scientific
question and teaching them export tools for efficient and reproducible work.
We propose that a course on this model should be the foundation for future
